...
module.exports = class Docks {
  ...
  static getInstanceIpFromId (instanceId) {
    return new Promise((resolve, reject) => {
      ...
      exec(cmd, (err, stdout, stderr) => {
        ...
        log.trace(put({ stdout: stdout }, logData), 'getInstanceIp: docks command successful')
  ...
  static markUnhealthy (instanceIp) {
    return new Promise((resolve, reject) => {
      ...
      exec(cmd, (err, stdout, stderr) => {
        ...
        log.trace(put({ stdout: stdout }, logData), 'markUnhealthy: docks command successful')
        resolve()
      })
    })
  }
  ...
  static killInstance (instanceIp) {
    return new Promise((resolve, reject) => {
      let cmd = 'echo y | docks kill -e ' + env + ' -i ' + instanceIp
      let logData = {
        cmd: cmd,
        instanceIp: instanceIp
      }
      ...
      exec(cmd, (err, stdout, stderr) => {
        ...
        log.trace(put({ stdout: stdout }, logData), 'killInstance: docks command successful')
        resolve()
      })
    })
  }
